...
\lstinputlisting[language=SQL, caption={Sample Data Insertion (\texttt{sql/data.sql})}, firstline=1, lastline=15]{../sql/data.sql}
...
\lstinputlisting[language=SQL, caption={Advanced Queries (\texttt{sql/queries.sql})}]{../sql/queries.sql}
