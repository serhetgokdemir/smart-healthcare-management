...
\textit{For each query in `queries.sql`, you should run it and paste the output here, possibly inside a `verbatim` environment or as a formatted table.}

\textbf{Query 1: Find doctors with more than X patients.}
\begin{verbatim}
-- Output of Query 1 here...
\end{verbatim}

\textbf{Query 2: List patients with no appointments.}
\begin{verbatim}
-- Output of Query 2 here...
\end{verbatim}
