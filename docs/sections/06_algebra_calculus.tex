...
\lstinputlisting[language=text, caption={Relational Algebra and Tuple Relational Calculus (\texttt{relational\_algebra\_and\_calculus.md})}]{../relational_algebra_and_calculus.md}
