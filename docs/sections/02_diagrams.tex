...
\textit{Note: The exported PNG is included in the repository. If you edit \texttt{diagrams/er\_diagram.mmd}, re-export it to \texttt{diagrams/er\_diagram.png}.}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=\textwidth]{../diagrams/eer_diagram.png}
    \caption{Enhanced Entity-Relationship (EER) Diagram.}
    \label{fig:eer_diagram}
\end{figure}

\textit{Note: The exported PNG is included in the repository. If you edit \texttt{diagrams/eer\_diagram.mmd}, re-export it to \texttt{diagrams/eer\_diagram.png}.}
